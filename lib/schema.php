    ...
    return [
        'site' => [
            ...
            'fields' => [
                ...
                ['key' => 'color_primary', 'label' => 'Hauptfarbe (UN-Blau)', 'type' => 'color'],
                ['key' => 'color_ink', 'label' => 'Dunkle Farbe (Text, Footer)', 'type' => 'color'],
                ['key' => 'color_accent', 'label' => 'Akzentfarbe (Schule)', 'type' => 'color'],
        ...
        'conference' => [
            ...
            'fields' => [
                ...
                ['key' => 'documents', 'label' => 'Dokumente (Geschäftsordnung, Code of Conduct …)', 'type' => 'repeater', 'fields' => [
                    ['key' => 'label', 'label' => 'Titel', 'type' => 'text'],
        ...
        'news' => [
            ...
            'fields' => [
                ...
                ['key' => 'published', 'label' => 'Veröffentlicht', 'type' => 'bool'],
            ],
        ],
        'gallery' => [
            'label' => 'Galerie',
